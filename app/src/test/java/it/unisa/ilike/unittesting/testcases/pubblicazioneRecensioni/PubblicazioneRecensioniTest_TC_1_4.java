...
/**
 * Implementa il testing di unità per TC_1_4 (Pubblicazione recensioni)
 * @author Francesco Giorgione
 */
@RunWith(Parameterized.class)
public class PubblicazioneRecensioniTest_TC_1_4 {
     ...
     */
    public PubblicazioneRecensioniTest_TC_1_4(IscrittoBean iscritto, ContenutoBean contenuto, String testo, int valutazione) {
    ...
    public void testCreaRecensione() throws Exception {
        ...
        assertNotNull(recensioneService.creaRecensione(testo, valutazione, iscritto, contenuto));
    }
}
