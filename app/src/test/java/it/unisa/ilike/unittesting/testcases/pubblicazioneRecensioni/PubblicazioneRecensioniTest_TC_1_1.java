...
/**
 * Implementa il testing di unità per TC_1_1 (Pubblicazione recensioni)
 * @author Francesco Giorgione
 */
@RunWith(Parameterized.class)
public class PubblicazioneRecensioniTest_TC_1_1 {
     ...
     */
    public PubblicazioneRecensioniTest_TC_1_1(IscrittoBean iscritto, ContenutoBean contenuto, String testo, int valutazione) {
