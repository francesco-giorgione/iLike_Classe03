...
/**
 * Questa classe di test fa riferimento al TC_3_3 in TCS.
 * Questa classe testa il metodo cancellaRecensione {@link SegnalazioneImpl}
 * @author Marta
 * @version 0.2
 */
@RunWith(Parameterized.class)
public class CancellaRecensioneTest_TC_3_3 {
     ...
     */
    public CancellaRecensioneTest_TC_3_3(SegnalazioneBean segnalazione, String motivazione, GestoreBean gestoreBean) {
    ...
    /**
     * Questo metodo esegue il TC_3_3.
     * @throws Exception
     */
    @Test
