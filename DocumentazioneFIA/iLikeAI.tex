...
\begin{document}
    ...
    \chapter{Evaluation}\label{ch:evaluation}
        ...
        tendono ad essere fin troppo piccoli. Per questo motivo, dopo aver valutato il trade-off numero di cluster VS errore commesso
        abbiamo ritenuto opportuno scegliere come valore k=8.
        ...
        Come mostrato nell'immagine soprastante, il valore di k ottimale è k=9, quindi la scelta è effettuare il clustering
        k-means impostando il parametro n\_{}cluster = 9.
        Questo grafico mostra, per n\_{}cluster=9, il valore del silhouette score e inoltre la divisione dei dati nei vari
        cluster ottenuti.
