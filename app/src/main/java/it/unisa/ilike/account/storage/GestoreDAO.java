...
/**
 * Un oggetto <code>GestoreDAO</code> serve per interagire con la tabella Iscritto presente nel database
 * @version 0.1
...
public class GestoreDAO {
     ...
     * presente nella tabella Gestore del database, dopo averlo individuato tramite l'email passata come argomento
    ...
    public GestoreBean doRetrieveByEmail(String email){
        ...
        String query = "select * from Gestore where email = '" + email + "' ";
    ...
    /*public boolean doSave(GestoreBean gestore){
        ...
        String query = "insert into Gestore (email, password, num_segnalazioni_gestite) values ('" +
