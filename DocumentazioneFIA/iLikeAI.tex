...
\begin{document}
    ...
    \chapter{Evaluation}\label{ch:evaluation}
        ...
        \section{DB-Scan Evaluation}\label{sec:dbscan-evaluation}
            \subsection{Silhouette Score}
                ...
                circolare, sia per il minimo numero di punti per considerare un intorno denso, abbiamo riportato di seguito le esecuzioni
                più rilevanti. I grafici sottoriportati evidenziano il valore del silhouette score e la divisione dei dati nei vari cluster
                ottenuti. La linea verticale tratteggiata rappresenta la media delle Silhouette Score calcolate in preceneza.
                ...
                Nel secondo grafico si può notare una suddivisione sub-ottima in cluster in quanto:
                \begin{itemize}
    ...
    \chapter{Integrazione con il sistema}\label{ch:integrazione-con-il-sistema}
        ...
        In questo modo andiamo ad istruire il bot su come rispondere alle domande o alle frasi dell'utente. Per la maggior parte delle domande
