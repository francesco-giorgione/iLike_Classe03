...
/**
 * Implementa il testing di unità per TC_4_3 (Creazione liste)
 * @author Simona Lo Conte
 */
@RunWith(Parameterized.class)
public class CreazioneListeTest_TC_4_3 {
     ...
     */
    public CreazioneListeTest_TC_4_3(String nome, IscrittoBean iscritto, Boolean pubblica) {
        this.nome = nome;
    ...
    public void init() {
        ...
        when(mockUtils.hasLista(iscritto,nome)).thenReturn(res);
